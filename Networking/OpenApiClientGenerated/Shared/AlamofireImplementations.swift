...
open class AlamofireRequestBuilder<T: Sendable>: RequestBuilder<T>, @unchecked Sendable {
    required public init(method: String, URLString: String, parameters: [String: any Sendable]?, headers: [String: String] = [:], requiresAuthentication: Bool, apiConfiguration: any MobilityAPIConfiguring) {
            ...
            validatedRequest.response(queue: apiConfiguration.apiResponseQueue,
                ...
                do {
                    ...
                    if let headerFileName = self.getFileName(fromContentDisposition: dataResponse.response?.allHeaderFields["Content-Disposition"] as? String) {
                        ...
                        requestPath = requestPath.appending("/tmp.CityBike.\(UUID().uuidString)")
                    }
